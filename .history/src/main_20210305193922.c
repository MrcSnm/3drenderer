...
///Key ESC
void exit_application(){isRunning = false;}
///Key 1
void set_wireframe_vertex(){PXRenderer_setState(PX_STATES_LINE|PX_STATES_VERTEX);}
///Key 2
void set_wireframe_only(){PXRenderer_setState(PX_STATES_LINE);}
///Key 3
void set_filled_only(){PXRenderer_setState(PX_STATES_FILL);}
///Key 4
void set_filled_wireframe(){PXRenderer_setState(PX_STATES_FILL|PX_STATES_LINE);}
///Key C
void set_culling_enabled(){PXRenderer_setCulling(PX_CULL_FRONT);}
///Key D
void set_culling_disabled(){PXRenderer_setCulling(PX_CULL_NONE);}
