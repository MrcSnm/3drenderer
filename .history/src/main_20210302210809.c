...
void render(void)
{
    ...
    //     pxDrawLine(t.points[0].x, t.points[0].y, t.points[1].x, t.points[1].y, 0xFF00FF00);
    //     pxDrawLine(t.points[1].x, t.points[1].y, t.points[2].x, t.points[2].y, 0xFF00FF00);
    //     pxDrawLine(t.points[2].x, t.points[2].y, t.points[0].x, t.points[0].y, 0xFF00FF00);
    // }

    pxDrawLine(300, 300, 300, 200, 0xFFFFFFFF);
