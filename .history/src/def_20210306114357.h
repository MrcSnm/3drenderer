...
#define profiling_start debug {  \
debug clock_t _prof_begin, _prof_end;\
debug _prof_begin = clock();\

#define profiling_end(name) debug _prof_end = clock(); \
debug print("Time spent on %s: %lf\n", name, (_prof_end - _prof_begin)/(double)CLOCKS_PER_SEC);\
debug }\
