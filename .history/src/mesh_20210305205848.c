...
face_t cube_faces[N_CUBE_FACES] = {
    ...
    //Right
    {3, 2, 4,-1, .color = 0xFFFF0000},
    {3, 4, 5,-1, .color = 0xFFFF0000},
    //Back
    {5, 4, 6,-1, .color = 0xFFFF0000},
    {5, 6, 7,-1, .color = 0xFFFF0000},
    //Left
    {7, 6, 1,-1, .color = 0xFFFF0000},
    {7, 1, 0,-1, .color = 0xFFFF0000},
    //Top
    {1, 6, 4,-1, .color = 0xFFFF0000},
    {1, 4, 2,-1, .color = 0xFFFF0000},
    //Bottom,
    {5, 7, 0,-1, .color = 0xFFFF0000},
    {5, 0, 3,-1, .color = 0xFFFF0000}
};
