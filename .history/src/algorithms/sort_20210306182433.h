...
///Insert sort, pass a function that returns a number < 0 for ascending order
#define insert_sort(arr, length, func) _insert_sort_impl(arr, length, typeof(arr[0]), func)
