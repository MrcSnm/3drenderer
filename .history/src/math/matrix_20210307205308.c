...
mat4 mat4_mult_mat4(mat4 a, mat4 b)
{
    ...
    {
        //C X R
        m[i][0] = a.m[i][0] * b.m[0][i]  + a.m[i][1] * b.m[1][i] + a.m[i][2]*b.m[2][i] + a.m[i][3]*b.m[3][i];
        m[i][1] = a.m[i][0] * b.m[0][i]  + a.m[i][1] * b.m[1][i] + a.m[i][2]*b.m[2][i] + a.m[i][3]*b.m[3][i];
        m[i][2] = a.m[i][0] * b.m[0][i]  + a.m[i][1] * b.m[1][i] + a.m[i][2]*b.m[2][i] + a.m[i][3]*b.m[3][i];
        m[i][3] = a.m[i][0] * b.m[0][i]  + a.m[i][1] * b.m[1][i] + a.m[i][2]*b.m[2][i] + a.m[i][3]*b.m[3][i];
    }
}
