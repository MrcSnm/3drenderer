...
mat4 mat4_projection_mat(float aspect, float fov, float znear, float zfar)
{
    float inverse_tan = 1/tan(fov/2);
    float z_length = zfar/(zfar-znear);

    return (mat4){
        {aspect*inverse_tan, 0, 0, 0},
        {0,        inverse_tan, 0, 0},
        {}
    };
